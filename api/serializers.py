...
class AssistantTrainingSerializer(serializers.Serializer):
    ...
    equipment_display = serializers.CharField(allow_blank=True)
    comment = serializers.CharField(allow_null=True, allow_blank=True)
    coach_comment = serializers.CharField(allow_null=True, allow_blank=True)
    coach_status = serializers.CharField()
    coach_status_display = serializers.CharField()
